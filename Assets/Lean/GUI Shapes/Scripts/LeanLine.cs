...
namespace Lean.Gui
{
	...
	[CustomEditor(typeof(LeanLine))]
	public class LeanLine_Editor : Common.LeanInspector<LeanLine>
	{
		...
		{
			Selection.activeObject = LeanHelper.CreateElement<LeanLine>(Selection.activeTransform);
		}
	}
}
#endif